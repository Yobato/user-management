...
export interface ProductMasterName{
  id: number;
  product_name: string;
}
...
export interface DataItem{
  id: number;
  // Ambil data dari Product Master
  product_master_name: ProductMasterName;
...
export class ProductCategoryService {
  ...
  productCategoryData: DataItem[] = [
    {
      ...
      product_category_name: "Griya Reguler",
      product_category_description: "Pembiayaan kepemilikan rumah, apartemen, atau ruko dengan prinsip syariah Murabahah (jual beli) dan angsuran tetap.",
    ...
    },
    {
      ...
      product_category_name: "OTO Reguler",
      product_category_description: "Solusi pembiayaan kendaraan bermotor (mobil atau motor) baru maupun bekas dengan akad Murabahah.",
    ...
    },
    {
      ...
      product_category_name: "Mitraguna Online",
      product_category_description: "Pembiayaan multiguna untuk berbagai kebutuhan konsumtif seperti pendidikan, perjalanan ibadah, atau renovasi rumah.",
    ...
    },
    {
      ...
      product_category_name: "Cicil Emas Pegawai",
      product_category_description: "Layanan kepemilikan emas batangan Logam Mulia dengan cara mencicil sesuai prinsip syariah.",
    ...
    },
    {
      ...
      product_category_name: "Card Program Pegawai",
      product_category_description: "Kartu pembiayaan syariah yang berfungsi seperti kartu kredit untuk berbagai transaksi halal di dalam dan luar negeri.",
  ...
  getById(id: number): DataItem | undefined{
    return this.productCategoryData.find(item => item.id === id);
  }
  ...
  getAllProductCategoryData(): DataItem[]{
